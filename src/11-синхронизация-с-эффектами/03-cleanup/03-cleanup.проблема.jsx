...
function Timer() {
    ...
    // Создайте useEffect с cleanup функцией:
    // - запускает setInterval который каждую секунду увеличивает seconds
    // - возвращает cleanup функцию, которая очищает интервал
    // useEffect(() => {
